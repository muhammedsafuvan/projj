...
def index(request):
    ...
    return render(request,'videos/index.html',context={"videos":Videos,"color": 'red'})
...
def device(request):
    ...
    if device_details==device_def:
        color = "blue"
        print("NO EXTERNAL DEVICE IS CONNECTED")
    else:
        print("EXTERNAL DEVICE IS DETECTED")

    return render(request,'base.html', {'abc':yell})
