...
safu_image = face_recognition.load_image_file("safuwan.jpg")
safu_face_encoding = face_recognition.face_encodings(anu_image)[0]
...
known_face_encodings = [
    obama_face_encoding,
    anu_face_encoding,akshay_face_encoding,safu_face_encoding
]
known_face_names = [
    "Barack Obama",
    "Anu","Akshay","Safu"
